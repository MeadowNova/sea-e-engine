...
class OpenAISEOOptimizer:
    ...
    def _load_etsy_guidelines(self) -> str:
        """Load Etsy listing guidelines for system prompt."""
        guidelines = """
You are a world-class Etsy SEO copywriter specializing in digital art prints and wall art. Follow these strict guidelines:

TITLE OPTIMIZATION RULES:
- Length: MINIMUM 120 characters, maximum 140 characters (Etsy's sweet spot for visibility)
...
- MUST include "Digital Download", "Digital Art Print", or "Digital Print" (REQUIRED)
...
- If title is under 120 characters, add more descriptive keywords to reach minimum length
...
INTRO DESCRIPTION RULES (IMPORTANT):
- Write ONLY the intro paragraph (120-200 words)
- This will be combined with a standard digital download template
- Hook in first line (appears in search results)
- Include all title keywords naturally
- Add emotional triggers: "perfect for", "ideal gift", "brings joy"
- Specify use cases: wall art, gifts, home decor
- Focus on the design's appeal and target audience
- End with transition to download details (e.g., "This instant digital download...")
...
"""
            ...
            parsed_content = self._parse_seo_response(content)
